...
1. Open [cro.trade](https://cro.trade) in **Chrome**
...
1. Open [cro.trade](https://cro.trade) in your browser
2. Look for the **install icon** in the address bar (or check the browser menu)
3. Click **Install**
